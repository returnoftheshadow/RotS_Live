...
constexpr JsApiStructFieldMapping FieldMappings[] = {
    ...
    {JsApiStructOwner::ObjData, "obj_data", "affected", "affects", "getAffects", "setAffects",
     "readonly ObjectAffect[]", false, Deferred, Deferred, "Planned read-only object affect array.",
     "Object affect writes are deferred until equipment recalculation rules are mapped.",
     "mutation", "Fixed array."},
    ...
    {JsApiStructOwner::ObjData, "obj_data", "description", "description", "getDescription",
     "setDescription", "string", false, Deferred, SetterPlanned,
     "Planned getter for the room-visible object description.",
    ...
    {JsApiStructOwner::ObjData, "obj_data", "short_description", "shortDescription",
     "getShortDescription", "setShortDescription", "string", false, Deferred, SetterPlanned,
     "Planned getter for the carried/worn short description.",
    ...
    {JsApiStructOwner::ObjData, "obj_data", "action_description", "actionDescription",
     "getActionDescription", "setActionDescription", "string | null", true, Deferred, SetterPlanned,
     "Planned getter for use/action text when present.",
    ...
    {JsApiStructOwner::ObjData, "obj_data", "ex_description", "extraDescriptions",
     ...
     Deferred, "Planned read-only snapshot of extra descriptions.",
    ...
    {JsApiStructOwner::RoomData, "room_data", "level", "level", "getLevel", "setLevel", "number",
     false, Deferred, Deferred, "Planned read-only room level.", "Room level writes are deferred.",
     "mutation", ""},
    ...
    {JsApiStructOwner::RoomData, "room_data", "description", "description", "getDescription",
     "setDescription", "string", false, Deferred, SetterPlanned,
     "Planned getter for the room long description.",
    ...
    {JsApiStructOwner::RoomData, "room_data", "alignment", "alignment", "getAlignment",
     "setAlignment", "number", false, Deferred, Deferred, "Planned read-only room alignment.",
    ...
    {JsApiStructOwner::ZoneData, "zone_data", "description", "description", "getDescription",
     "setDescription", "string | null", true, Deferred, SetterPlanned,
     "Planned getter for the zone description.",
    ...
    {JsApiStructOwner::ZoneData, "zone_data", "map", "map", "getMap", "setMap", "string | null",
     true, Deferred, SetterPlanned, "Planned getter for the zone map text.",
    ...
    {JsApiStructOwner::ZoneData, "zone_data", "lifespan", "lifespan", "getLifespan", "setLifespan",
     "number", false, Deferred, Deferred, "Planned read-only minutes between zone resets.",
    ...
    {JsApiStructOwner::ZoneData, "zone_data", "age", "age", "getAge", "setAge", "number", false,
     Deferred, Unsupported, "Planned read-only current zone age in minutes.",
    ...
    {JsApiStructOwner::ZoneData, "zone_data", "top", "topRoomVnum", "getTopRoomVnum",
     "setTopRoomVnum", "number", false, Deferred, Unsupported,
     "Planned read-only upper room vnum for the zone.",
     "Changing zone room bounds from "
     "JavaScript is unsupported.",
     "none", "World topology field."},
    {JsApiStructOwner::ZoneData, "zone_data", "x", "x", "getX", "setX", "number", false, Deferred,
     Deferred, "Planned read-only zone map x coordinate.",
     "Zone coordinate writes are deferred until map validation is mapped.", "mutation", ""},
    {JsApiStructOwner::ZoneData, "zone_data", "y", "y", "getY", "setY", "number", false, Deferred,
     Deferred, "Planned read-only zone map y coordinate.",
     "Zone coordinate writes are deferred until map validation is mapped.", "mutation", ""},
    {JsApiStructOwner::ZoneData, "zone_data", "symbol", "symbol", "getSymbol", "setSymbol",
     "string", false, Deferred, Deferred, "Planned read-only zone map symbol.",
    ...
    {JsApiStructOwner::ZoneData, "zone_data", "level", "level", "getLevel", "setLevel", "number",
     false, Deferred, Deferred, "Planned read-only zone level.",
    ...
    {JsApiStructOwner::ZoneData, "zone_data", "min_level_look", "minimumLookLevel",
     "getMinimumLookLevel", "setMinimumLookLevel", "number", false, Deferred, Deferred,
     "Planned read-only minimum level required to inspect zone map/details.",
    ...
    {JsApiStructOwner::ZoneData, "zone_data", "reset_mode", "resetMode", "getResetMode",
     "setResetMode", "number", false, Deferred, Deferred, "Planned read-only zone reset mode.",
