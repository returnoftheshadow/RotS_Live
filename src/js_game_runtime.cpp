    ...
    const JsGameTriggerContextFixture& context, const char* filename)
{
    ...
    wrapped << trigger_context_preamble(context)
            << "const __rotsReturn = (function(ctx, __rotsMutations, __rotsAttachTextSetter, "
               ...
               "__rotsAttachLifespanSetter, __rotsAttachSetterApi, __rotsValidateTextSetter, __rotsValidateSymbolSetter, "
               "__rotsValidateCoordinateSetter, __rotsValidateResetModeSetter, "
               "__rotsValidateLifespanSetter, __rotsMutationResult, __rotsDeepFreeze, __rotsJsonStringify, __rotsNumberIsInteger, "
               "__rotsString) {\n"
            << "  'use strict';\n"
            << source << "\n"
