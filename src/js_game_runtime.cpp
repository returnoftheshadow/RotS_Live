...
std::string trigger_context_preamble(const JsGameTriggerContextFixture &context) {
    ...
    wrapped
        ...
        << "const __rotsLiveHandles = new WeakSet();\n"
        << "function __rotsDeepFreeze(value) {\n"
        << "  if (value && (typeof value === 'object' || typeof value === 'function') && "
           "!Object.isFrozen(value)) {\n"
        << "    if (typeof value === 'object' && value.__rotsReadOnlySnapshot !== true && "
           "typeof value.id === 'string' && typeof value.isValid === 'function' && "
           "value.isValid() === true) __rotsLiveHandles.add(value);\n"
        ...
        << "  if (!value || typeof value !== 'object' || typeof value.id !== 'string' || "
           ...
           "!__rotsLiveHandles.has(value)) return null;\n"
...
JsRuntimeEvalResult JsGameRuntime::evaluate_trigger_body(const std::string &source,
    ...
    wrapped
        ...
        << "const __rotsReturn = (function(ctx, __rotsMutations, __rotsAttachTextSetter, "
           ...
           "__rotsString, __rotsLiveHandles) {\n"
        << "  'use strict';\n"
        << source << "\n"
