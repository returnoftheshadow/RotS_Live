...
constexpr JsApiMember CharacterMembers[] = {
    ...
    {"inventory", JsApiMemberKind::Property, "readonly InventoryObjectSnapshot[]", "", false,
...
constexpr JsApiMember SkillValueMembers[] = {
    ...
    {"minimumPosition", JsApiMemberKind::Property, "number", "", false, true,
     JsApiSideEffect::None, JsApiMemberStatus::PlannedReadOnly, "read-only",
    ...
    {"learnDifficulty", JsApiMemberKind::Property, "number", "", false, true,
     JsApiSideEffect::None, JsApiMemberStatus::PlannedReadOnly, "read-only",
     "Learning difficulty value from the live skill table."},
    {"learnType", JsApiMemberKind::Property, "number", "", false, true,
     JsApiSideEffect::None, JsApiMemberStatus::PlannedReadOnly, "read-only",
    ...
    {"specialization", JsApiMemberKind::Property, "number", "", false, true,
     JsApiSideEffect::None, JsApiMemberStatus::PlannedReadOnly, "read-only",
...
constexpr JsApiMember AffectMembers[] = {
    ...
    {"locationName", JsApiMemberKind::Property, "string", "", false, true,
     JsApiSideEffect::None, JsApiMemberStatus::PlannedReadOnly, "read-only",
...
constexpr JsApiType ApiTypes[] = {
    ...
    {"SkillValue", JsApiTypeKind::Interface, "",
     "Frozen read-only trained skill practice entry.", SkillValueMembers,
     sizeof(SkillValueMembers) / sizeof(SkillValueMembers[0])},
