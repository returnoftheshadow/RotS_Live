...
constexpr JsApiMember CharacterMembers[] = {
    ...
    { "maxHitPoints", JsApiMemberKind::Property, "number", "", false, true,
...
constexpr JsApiMember PlayerMembers[] = {
    { "accountName", JsApiMemberKind::Property, "string | null", "", true, true,
        JsApiSideEffect::None, JsApiMemberStatus::PlannedReadOnly, "read-only",
        "Player account name when it is safe to expose to the builder context; otherwise null." },
...
constexpr JsApiMember MobMembers[] = {
    { "prototypeVnum", JsApiMemberKind::Property, "number", "", false, true,
        JsApiSideEffect::None, JsApiMemberStatus::PlannedReadOnly, "read-only",
        "Mobile prototype vnum backing this NPC." },
};
...
constexpr JsApiMember GameObjectMembers[] = {
    ...
    { "room", JsApiMemberKind::Property, "Room | null", "", true, true, JsApiSideEffect::None,
        JsApiMemberStatus::PlannedReadOnly, "read-only",
        "Room containing the object, or null when carried, worn, nested, or invalid." },
    { "carriedBy", JsApiMemberKind::Property, "Character | null", "", true, true,
        JsApiSideEffect::None, JsApiMemberStatus::PlannedReadOnly, "read-only",
        "Character carrying the object, or null." },
    { "wornBy", JsApiMemberKind::Property, "Character | null", "", true, true,
        JsApiSideEffect::None, JsApiMemberStatus::PlannedReadOnly, "read-only",
        "Character wearing the object, or null." },
    { "isValid", JsApiMemberKind::Method, "() => boolean", "boolean", false, false,
        JsApiSideEffect::None, JsApiMemberStatus::PlannedPureHelper, "pure",
...
constexpr JsApiMember TriggerInfoMembers[] = {
    ...
    { "legacyValue", JsApiMemberKind::Property, "number", "", false, false,
        JsApiSideEffect::None, JsApiMemberStatus::PlannedReadOnly, "read-only",
        "Legacy numeric trigger id or ASIMA/Mudlle call flag value." },
    { "legacyName", JsApiMemberKind::Property, "string", "", false, false,
        JsApiSideEffect::None, JsApiMemberStatus::PlannedReadOnly, "read-only",
        "Legacy manifest name such as ON_ENTER or SPECIAL_COMMAND." },
    { "handlerName", JsApiMemberKind::Property, "string", "", false, false,
        JsApiSideEffect::None, JsApiMemberStatus::PlannedReadOnly, "read-only",
...
constexpr JsApiMember ScriptContextMembers[] = {
    ...
    { "text", JsApiMemberKind::Property, "string | null", "", true, false,
        JsApiSideEffect::None, JsApiMemberStatus::PlannedReadOnly, "read-only",
    ...
    { "wearSlot", JsApiMemberKind::Property, "string | null", "", true, false,
        JsApiSideEffect::None, JsApiMemberStatus::PlannedReadOnly, "read-only",
        "Equipment slot name for wear triggers when known." },
    { "command", JsApiMemberKind::Property, "string | null", "", true, false,
        JsApiSideEffect::None, JsApiMemberStatus::PlannedReadOnly, "read-only",
        "Command name for ASIMA/Mudlle command and target call flags." },
    { "args", JsApiMemberKind::Property, "string | null", "", true, false,
        JsApiSideEffect::None, JsApiMemberStatus::PlannedReadOnly, "read-only",
        "Sanitized command argument string." },
    ...
    { "tick", JsApiMemberKind::Property, "number | null", "", true, false,
        JsApiSideEffect::None, JsApiMemberStatus::PlannedReadOnly, "read-only",
    ...
    { "continuation", JsApiMemberKind::Property, "never", "", false, false,
        JsApiSideEffect::None, JsApiMemberStatus::Unsupported, "unsupported",
        "JavaScript continuations are not part of v1; SPECIAL_DELAY remains unsupported." },
    { "targ1", JsApiMemberKind::Property, "unknown | null", "", true, true,
        JsApiSideEffect::None, JsApiMemberStatus::Deferred, "deferred",
        "Legacy target slot whose safe typed shape is deferred." },
    { "targ2", JsApiMemberKind::Property, "unknown | null", "", true, true,
        JsApiSideEffect::None, JsApiMemberStatus::Deferred, "deferred",
...
constexpr JsApiMember ScriptMembers[] = {
    ...
    { "extractCharacter", JsApiMemberKind::Method, "(target: Character) => never", "never",
        false, true, JsApiSideEffect::WorldMutation, JsApiMemberStatus::Unsupported,
        "unsupported", "Entity extraction is not exposed to builder JavaScript in v1." },
};
...
constexpr JsApiType ApiTypes[] = {
    ...
    { "Script", JsApiTypeKind::Namespace, "",
        "Deferred or unsupported side-effect helpers. Nothing here is callable in v1.",
