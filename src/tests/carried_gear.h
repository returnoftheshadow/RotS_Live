...
// sit directly in the corpse only when the death_strips_corpse_containers() rule applies; for
// the legacy class an NPC death takes, that is a non-NPC killer or SPELL_POISON. Where the item
