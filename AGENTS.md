...
- Current slice: JavaScript API next non-object setter classification. Reassess room/zone/character getter fields after the object flag deferrals and pick either a narrow persisted setter or an explicit deferral.
- Next slice: JavaScript API next non-object setter implementation or deferral slice based on that classification.
