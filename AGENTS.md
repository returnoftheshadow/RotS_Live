...
- Current slice: JavaScript API next safe setter group selection slice. Audit the remaining implemented getter fields for clear ownership, value domain, persistence, live dispatch target, side effects, and offline parity path before promoting another setter.
- Next slice: JavaScript API next safe setter implementation slice, based on the selection audit results.
