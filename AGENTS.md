...
- Current slice: JavaScript API next safe object scalar classification after `GameObject.setRarity`. Decide whether any remaining `ObjectFlags` scalar should be promoted or whether weight/cost/timer/material/type/flag bitsets should stay deferred until side-effect policies are explicit.
- Next slice: JavaScript API next safe object scalar implementation or deferral slice based on the remaining object-scalar classification.
