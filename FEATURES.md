...
- Initial server-owned host API contract implementation:
  ...
  - Initial accessor/mutator rollout order:
    ...
    - Current promoted read-only getter coverage includes character prototype/room and object room/carrier relationships, core object/room/zone names and vnums, room descriptions/level/sector type/alignment/light/sunlit state, filtered room flag names that exclude transient/internal bits, object descriptions, object action descriptions, filtered object flag snapshots for symbolic item type, wear flags, extra flags, material, and scalar level/weight/cost/rent/timer/rarity fields, and safe nullable/scalar zone fields including description, map, lifespan, age, top room vnum, coordinates, symbol, minimum look level, reset mode, and level.
