...
- Initial server-owned host API contract implementation:
  ...
  - Initial accessor/mutator rollout order:
    ...
    - Next character movement helper slice: design `loadMob(vnum, room)` only after mobile prototype catalogs, generated temporary IDs, room membership, script/proc initialization policy, reset-balance effects, audit fields, no returned mutable handle, and offline fixture state are pinned.
