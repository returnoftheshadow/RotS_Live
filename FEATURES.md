...
- Initial server-owned host API contract implementation:
  ...
  - Generated TypeScript declarations should emit only callable/readable APIs that are implemented in the live runtime and offline runner. Planned or unsupported setters remain documented in the API reference until both live execution and offline fixture emulation support them.
