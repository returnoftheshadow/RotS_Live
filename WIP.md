...
- Current slice: JavaScript `load_obj` final result bridge retrofit. Add server-owned final result classification for missing prototypes, invalid targets, target authority, inventory count, carried weight, audit rejection, and transaction-accepted success, then mirror the same codes in BuilderClient offline fixtures.
- Next slice: JavaScript `load_obj` final result bridge retrofit. Add server-owned final result classification for missing prototypes, invalid targets, target authority, inventory count, carried weight, audit rejection, and transaction-accepted success, then mirror the same codes in BuilderClient offline fixtures.
