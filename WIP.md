...
- Next slice: BuilderClient modern TypeScript API cleanup. Update existing docs, examples, generated/fallback typings, and offline helper tests so camelCase helpers are taught first, snake-case names are documented as migration aliases, fixture UI/docs use builder outcome language instead of legacy implementation terms, and higher-level helper design notes replace one-thin-wrapper-per-opcode planning where appropriate.
