...
- Next slice: JavaScript command-result offline object prototype catalog parity. Add fixture prototype data so BuilderClient can exercise `load_obj` `not-found` and prototype-weight/capacity result branches offline.
