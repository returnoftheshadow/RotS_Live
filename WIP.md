...
- Next slice: Legacy output/social compatibility examples. Add executable examples and modern TypeScript helpers for the active corpus output/social gaps: `sendToRoomExcept`, `yell`, `emote`, `social`, and `pageZoneMap`, with snake-case aliases only where useful for migration.
