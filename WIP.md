...
- Current slice: JavaScript API builder documentation completeness pass. Verify generated API reference, TypeScript/JSDoc hover text, manifest docs, FEATURES.md, and offline/client-facing help explain every getter/setter status, mutation result shape, unsupported/deferred rationale, and live/offline parity requirement for builders before declaring accessor documentation complete.
- Next slice: JavaScript API builder documentation completeness pass. Verify generated API reference, TypeScript/JSDoc hover text, manifest docs, FEATURES.md, and offline/client-facing help explain every getter/setter status, mutation result shape, unsupported/deferred rationale, and live/offline parity requirement for builders before declaring accessor documentation complete.
