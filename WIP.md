...
- Next slice: Legacy output/social parity examples. Add executable examples and helpers for the active corpus output/social gaps: `send_to_room_x`, `do_yell`, `do_emote`, `do_social`, and `page_zone_map`.
...
- Small-slice execution queue:
  ...
  - [ ] Legacy output/social parity examples slice: add executable examples and helpers for `send_to_room_x`, `do_yell`, `do_emote`, `do_social`, and `page_zone_map`.
  - [ ] Legacy object variable/lookup parity slice: model `assign_inv`, `assign_eq`, `assign_room`, `load_obj_x`, and local object variables.
  - [ ] Legacy object movement/extract parity slice: add audited object move/extract/drop helpers and no-partial rollback coverage.
  - [ ] Legacy character movement helper slice: add audited `loadMob`, teleport, extract, follow, and flee helpers.
  - [ ] Legacy combat/death helper slice: add guarded `doHit`, `rawKill`, and `gainExp` equivalents.
