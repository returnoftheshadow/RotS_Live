...
- Next slice: JavaScript command-result offline command-state isolation parity. Pin that hidden accepted object-helper state is per fixture run and cannot leak across repeated offline executions of the same fixture.
