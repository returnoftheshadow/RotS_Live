...
- Current slice: JavaScript API `Character`/`GameObject` residual internal-alias audit final commit.
- Next slice: JavaScript API final getter/setter closure audit. Re-scan the public struct mapping catalog, generated contract, docs, live QuickJS role matrix, BuilderClient typings, compiler, IPC, and offline fixtures for any remaining unclassified getter/setter drift before declaring the C++ owner surfaces fully guarded.
