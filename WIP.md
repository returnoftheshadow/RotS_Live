...
- Current slice: JavaScript API deferred helper prioritization pass. Convert the documented deferred/unsupported setter policies into a prioritized backlog of narrow helper APIs for movement, room flags, exits, affects, inventory/equipment, object value domains, reset commands, faction power, and profile/admin updates without exposing raw struct fields.
- Next slice: JavaScript API deferred helper prioritization pass. Convert the documented deferred/unsupported setter policies into a prioritized backlog of narrow helper APIs for movement, room flags, exits, affects, inventory/equipment, object value domains, reset commands, faction power, and profile/admin updates without exposing raw struct fields.
