...
- Current slice: JavaScript API room flag helper offline/generated contract parity slice. Add BuilderClient/offline fixture parity, generated API docs/typings entries, and tests that keep helper methods absent until the live helper call shape and per-flag side-effect/authorization policy are ready.
- Next slice: JavaScript API room flag helper offline/generated contract parity slice. Add BuilderClient/offline fixture parity, generated API docs/typings entries, and tests that keep helper methods absent until the live helper call shape and per-flag side-effect/authorization policy are ready.
...
- Small-slice execution queue:
  ...
  - [ ] JavaScript API room flag helper offline/generated contract parity slice: add BuilderClient/offline fixture parity, generated API docs/typings entries, and tests that keep helper methods absent until the callable helper shape is ready.
