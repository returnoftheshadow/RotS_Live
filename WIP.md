...
- Next slice: Modern reward/custody helper design slice. Design higher-level TypeScript helpers for common legacy reward, object custody, and inventory workflows without exposing raw one-opcode wrappers or unsafe ownership fields.
...
- Small-slice execution queue:
  ...
  - [ ] Modern reward/custody helper design slice: replace raw legacy temp-object workflows with typed helper APIs that cover object lookup, load, custody, transfer, extraction, result codes, and rollback without exposing raw pointer slots to builders.
