...
- Small-slice execution queue:
  ...
  - [ ] Legacy output/social compatibility examples slice: add executable examples and modern TypeScript helpers for `sendToRoomExcept`, `yell`, `emote`, `social`, and `pageZoneMap`, with snake-case aliases only where useful for migration.
