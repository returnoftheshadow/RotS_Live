...
- Next slice: JavaScript command-result offline wait-list state parity. Add fixture state for already-waiting hosts so BuilderClient can exercise `do_wait` `already-waiting` branches offline.
